...
import Remote from '../public/assets/mic.png';
import Mic from '../public/assets/mic.png';
import Headphones from '../public/assets/trophy.png';
  ...
  return (
    <div className='p-2 md:p-8'>
      ...
      <div className='grid sm:grid-cols-3 lg:grid-cols-5 gap-4 border-t border-gray-700 py-8'>
        {/*Grid Item */}
        <div className='w-full h-[50px] bg-[#9147ff] hover:bg-[#bf94ff] cursor-pointer flex justify-between items-center px-4 rounded'>
