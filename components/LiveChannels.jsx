  ...
  return (
    <div id='live' className='p-2 md:p-8'>
        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-4 py-2'>
            <LiveChannelItem 
            img={Live1}
            profile_img='https://static-cdn.jtvnw.net/jtv_user_pictures/0347a9aa-e396-49a5-b0f1-31261704bab8-profile_image-300x300.jpeg'
            title='CHARITY STREAM! Did America deser...'
            user='HankPecker'
