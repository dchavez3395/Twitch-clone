...
const Account = () => {
        ...
        return (
            <div className='pt-[100px] flex flex-col max-w-[400px] w-full mx-auto p-4'>
                ...
                <div className='pb-4 m-auto'>
                    <Image src={session.user.image} alt="/" className='rounded-full' width='100' height='100' />
                </div>
                <button 
    ...
    return (
        <div className='pt-[100px] flex flex-col max-w-[400px] w-full mx-auto p-4'>
            ...
            onClick={() => signIn()}
            >
            <FaGithub className='mr-2' />Sign in<span className='font-bold pl-1'>Github</span></button>
            <button className='flex items-center justify-center p-3 bg-blue-600 border border-gray-600 my-2' 
            onClick={() => signIn()}
            >
            <FaGoogle className='mr-2' />Sign in<span className='font-bold pl-1'>Google</span></button>
        </div>
    )
}
